...
class LoginTest {
    ...
    public void test() throws Exception{
        this.mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("Спроси Адама Ельмурзаева")))
                .andExpect(content().string(containsString("Войти")));
    }

    @Test
    public void accessDeniedTest() throws Exception{
        this.mockMvc.perform(get("/questions/ask"))
                .andDo(print())
    ...
    public void badCredentials() throws Exception{
        this.mockMvc.perform(post("/login").param("user", "adamibnkhavaj@gmail.com"))
                .andDo(print())
